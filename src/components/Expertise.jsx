        ...
        >
          <div className="flex text-white justify-around  w-full">
            ...
            <div className="w-2/3 text-center space-y-4 ">
              ...
              <p>
                Experienced in Core Java and J2EE for enterprise applications, I utilize Hibernate for ORM and Spring Framework/Spring Boot for robust, scalable solutions. Skilled in Spring Security for application protection, JavaScript and ReactJS for interactive UIs, and Kafka for real-time data processing. Proficient in Microservices architecture for building scalable, modular systems.
              </p>
